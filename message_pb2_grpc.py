...
class AuthenticationServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Login = channel.unary_unary(
                '/messageapp.AuthenticationService/Login',
...
def add_AuthenticationServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'messageapp.AuthenticationService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('messageapp.AuthenticationService', rpc_method_handlers)
